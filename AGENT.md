...
## Objective
Maintain `agent-cli` as a reliable, useful, and test-first project aligned with its primary promise:
> Universal CLI for agent run, test, logs, and deploy workflows.
